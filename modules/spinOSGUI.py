...
class SpinOSGUI:
    ...
    def __init__(self, master, wwd, width, height):
        ...
        rv1check = ttk.Checkbutton(filesframe, var=self.load_rv1, command=self.toggle_rv1)
        rv2check = ttk.Checkbutton(filesframe, var=self.load_rv2, command=self.toggle_rv2)
        ascheck = ttk.Checkbutton(filesframe, var=self.load_as, command=self.toggle_as)
        ...
        self.seppa_but = tk.Radiobutton(filesframe, text='Sep/PA', variable=self.seppa, value=True,
                                        fg=cst.FONTCOLOR, bg=cst.BGCOLOR, state=tk.DISABLED)
        ...
        ttk.Button(filesframe, text='Load Data', command=self.datamanager.loaddataintoSets,
        ...
        self.seppa_but_dtmgr = tk.Radiobutton(self.as_tab, text='Sep/PA', variable=self.seppa,
                                              bg=cst.BGCOLOR, fg=cst.FONTCOLOR,
                                              value=True)
        self.seppa_but_dtmgr.pack(side=tk.LEFT, expand=1)
        self.en_but_dtmgr = tk.Radiobutton(self.as_tab, text='E/N', variable=self.seppa,
                                           bg=cst.BGCOLOR, fg=cst.FONTCOLOR,
                                           value=False)
        ...
        self.guess_entry_list = [
            ttk.Entry(guess_frame, textvariable=self.guess_var_list[i], width=10) for i in rparams]
        # put in a nice grid
        for i in rparams:
        ...
        self.vary_button_list = [ttk.Checkbutton(guess_frame, var=self.vary_var_list[i]) for i in
                                 rparams]
        ...
        self.error_label_list = [
            ttk.Label(guess_frame, textvariable=self.error_var_list[i], width=8)
            for i in rparams]
        for i in rparams:
        ...
        ttk.Button(guess_frame, text='Save parameters', command=self.save_params,
        ...
        tk.Radiobutton(methodframe, text='Levenberg-Marquardt', variable=self.method,
                       fg=cst.FONTCOLOR,
                       value='leastsq', bg=cst.BGCOLOR, command=self.toggle_method).grid(row=1,
                                                                                         column=1,
                                                                                         sticky=tk.W)
        ...
        ttk.Label(otherminframe, text='Results', font=('', cst.TITLESIZE, 'underline')) \
        ...
        self.phase_slider = tk.Scale(plt_frame, variable=self.plotter.phase, from_=0, to=1,
                                     orient=tk.HORIZONTAL, bg=cst.BGCOLOR, fg=cst.FONTCOLOR,
        ...
        self.plot_rv1model_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_modelrv1,
                                                    state=tk.DISABLED)
        ...
        self.plot_gamma1_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_modelgamma1,
                                                  state=tk.DISABLED)
        ...
        self.plot_rv2model_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_modelrv2,
                                                    state=tk.DISABLED)
        ...
        self.plot_gamma2_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_modelgamma2,
                                                  state=tk.DISABLED)
        ...
        self.plot_asmodel_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_modelas,
                                                   state=tk.DISABLED)
        ...
        self.plot_nodeline_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_nodeline,
                                                    state=tk.DISABLED)
        ...
        self.plot_semimajor_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_semimajor,
                                                     state=tk.DISABLED)
        ...
        self.plot_peri_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_peri,
                                                state=tk.DISABLED)
        ...
        self.as_dist_button = ttk.Checkbutton(plt_frame, var=self.plotter.do_as_dist,
                                              state=tk.DISABLED)
        ...
        self.modelwidgets = {self.plot_asmodel_label, self.plot_asmodel_button,
                             ...
                             self.pphase_but, self.ptime_but, self.plot_gamma1_button,
        ...
        ttk.Entry(settings_frame, textvariable=self.plotter.axeslabelsize, width=15) \
            .grid(row=1, column=entrycol, columnspan=2)
        
        ttk.Label(settings_frame, text='Tick label size').grid(row=2, sticky=tk.E)
        ttk.Entry(settings_frame, textvariable=self.plotter.ticklabelsize, width=15) \
            .grid(row=2, column=entrycol, columnspan=2)
        
        ttk.Label(settings_frame, text='Grid visibility').grid(row=3, sticky=tk.E)

        self.grid_button = ttk.Checkbutton(settings_frame, var=self.plotter.do_grids)
